    ...
    <div className="flex-1 bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/40 backdrop-blur-md animate-slide-in-left">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">            <div className="flex items-center space-x-4 animate-slide-in-left animate-delay-150">
        ...
        {data && (
          <>
            ...
            <section className="space-y-6 animate-fade-in-up">
              ...
              <div className="chart-enter">
                <GeographicChart data={data.geoData} />
              </div>
            </section>
            ...
            <section className="space-y-6 animate-fade-in-up">
              ...
              <div className="chart-enter">
                <OrganicChart data={data.organicData.sessionsOverTime} />
              </div>
            </section>
            ...
            <section className="space-y-6 animate-fade-in-up">
              <h2 className="text-2xl font-bold text-white">Top Landing Pages from Organic Search</h2>              <div className="animate-slide-up">
                <LandingPagesTable data={data.topLandingPages} />
              </div>
            </section>
          </>
        )}
