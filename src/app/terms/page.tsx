        ...
        <div className="space-y-8 text-white/90">
          <section>
            ...
            <div className="space-y-4">
              <p>
                By accessing and using the KWMT Marketing Analytics Dashboard ("the Service"), you accept and agree to
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p>
                We only access your Google Analytics data to display it in our dashboard interface. We do not store,
                sell, or share your analytics data with third parties.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                While we strive to keep the Service available 24/7, we do not guarantee uninterrupted access. The
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                KWMT Marketing shall not be liable for any indirect, incidental, special, consequential, or punitive
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                You may discontinue use of the Service at any time by revoking Google OAuth access. We may terminate or
                suspend access to our Service immediately, without prior notice, if you breach these Terms.
              </p>
            </div>
          </section>
