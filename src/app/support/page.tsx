              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                    ...
                    <p>Simply click "Sign in with Google" on the main page. You'll be prompted to grant read-only access to your Google Analytics data. We only request the minimum permissions needed to display your analytics.</p>
                  </div>

                  <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                    <h3 className="text-lg font-semibold text-white mb-2">What data do you access?</h3>
                    <p>We only access your Google Analytics data in read-only mode to display metrics and create visualizations. We don't store your analytics data on our servers - it's fetched in real-time when you view the dashboard.</p>
                  </div>
                  ...
                  <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                    ...
                    <p>Yes! We use industry-standard security practices including HTTPS encryption for all data transmission and secure OAuth authentication. We never store your analytics data on our servers.</p>
                  </div>
                </div>
              </section>
                ...
                <div className="space-y-4">
                  <div className="bg-white/5 p-6 rounded-lg border border-white/10">
                    <p className="mb-4">
                      ...
                      Our goal is to make website analytics more accessible and easier to understand for businesses of all sizes.
                    </p>
                    <div className="space-y-2">
